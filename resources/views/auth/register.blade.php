  ...
  <div class="rb-center">
    <div id="login-card">
      ...
      <form method="POST" action="{{ route('register') }}">
        ...
        <label for="">มีรหัสแล้วอยู่หรือป่าว?</label> <a href="{{ route('login') }} " class="clicktologin" >ถ้ามีคลิ๊กที่นี่</a>
