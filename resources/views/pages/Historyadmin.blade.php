...
<style>
  html,body{margin:4%;padding:0;height:100%;font-family:"Noto Sans Thai UI",sans-serif;}
  .modal.show {display:flex;} /* ต้องมีเพื่อให้เห็น modal เมื่อ add class show */
</style>
...
<div class="wrap">
  ...
  <table>
    <thead>
      <tr>
        <th>ห้อง</th><th>เริ่ม</th><th>ถึง</th><th>วันที่จอง</th><th>จัดการ</th><th>คำร้องขอ</th>
      </tr>
    </thead>
    <tbody>
      @forelse($rows as $r)
  ...
  <div class="modal__panel" role="dialog" aria-modal="true" aria-labelledby="editTitle">
    ...
    <div class="modal__footer">
        <form id="deleteForm" method="POST"
                onsubmit="return confirm('คุณต้องการลบการจองนี้หรือไม่?');"
                style="margin:0;">
            @csrf
            @method('DELETE')
