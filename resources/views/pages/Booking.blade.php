@extends('layouts.app')
 <style>
    ...
    .bk-btn{display:inline-flex;align-items:center;gap:6px;border-radius:18px;border:1px solid #C9CDD2;background:#F6F7F8;padding:6px 14px}
    ...
    <div class="bk-card">
      <div class="bk-grid">
        <div>
          ...
          <input class="bk-input" value="CP9127" disabled>
        </div>
        <div>
